...
package org.jretty.servletfile.fileupload;
...
public class MultipartRequest {
    ...
    public static final int MAX_POST_SIZE = 30720 * 1024; // 30M
    
    public static final String UTF8_ENCODING = "UTF-8"; // common encoding
    ...
    //protected final String[] allowedExt;
...
public MultipartRequest(HttpServletRequest request,
    ...
    if (!POST_METHOD.equalsIgnoreCase(request.getMethod())) {
        throw new IllegalArgumentException("request must be POST method");
    }
