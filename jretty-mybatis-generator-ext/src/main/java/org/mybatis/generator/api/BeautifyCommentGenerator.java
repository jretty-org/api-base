 ...
 * @author zollty
 */
public class BeautifyCommentGenerator implements CommentGenerator {
     ...
     */
    public BeautifyCommentGenerator() {
        super();
...
//        javaElement.addJavaDocLine(sb.toString());
    ...
    public void addFieldComment(Field field,
		...
		if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
			String[] remarkLines = remarks.split(System.getProperty("line.separator")); //$NON-NLS-1$
			sb.append(": ").append(remarkLines[0]);
			for (int i = 1; i < remarkLines.length; i++) {
				sb.append(" * " + remarkLines[i]); //$NON-NLS-1$
			}
		}
...
//        method.addJavaDocLine(" */"); //$NON-NLS-1$
    ...
    public void addGetterComment(Method method,
        ...
        sb.append(" * This method returns the value of the "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append('.');
    ...
    public void addSetterComment(Method method,
        ...
        sb.append(" * This method sets the value of the "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append('.');
        sb.append(introspectedColumn.getActualColumnName());
        method.addJavaDocLine(sb.toString());
